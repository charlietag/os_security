...
# Check app version
check_app "cwaf-rules-version" "${PARAM_COMODO_RULES_VER}"
...
wget \
--content-disposition \
https://github.com/charlietag/cwaf_charlietag/raw/master/output/cwaf_rules_nginx_3-${PARAM_COMODO_RULES_VER}.tgz \
 -O - | tar -xz
